...
const resume_obj = [
  {
    ...
    leftBecause:
      "Laid off during extended probation. Was too much of a team-player which they didn't need currently. We parted ways amicably and I received a letter of recommendation",
    content: [
      "Developing and maintaining the backend ad-server. Adding new features and improving the performance of existing code using Python, Github, AWS, Jira",
    ],
  },
  {
    ...
    leftBecause:
      "Moved from Alberta to Quebec, Canada. Asked Lone Wolf if they could set up taxes in the province of Quebec for me and they said no",
    content: [
      "Developing several real estate technology apps using PHP, Java, Kotlin, React, Typescript, Python, SQL, Bash, Kanban Board, Github, Docker, AWS",
  ...
  },
  {
    ...
    leftBecause:
      "Received a paycut due to covid. Wanted to try trading stocks as full time income",
    content: [
      "Developed the app backend using Python/Django, Docker and PostgreSQL",
  ...
  },
  {
    ...
    content: [
      "Designed oil field tools using 3D modeling and FEA",
  ...
  },
  {
    ...
    content: [
      "Theoretical design and physical construction of novel low-concentration photovoltaic system prototypes; including using different mirror shapes and materials along with efficiency losses due to heat trapping",
  ...
  {
    company:
      "Micro Engineering Dynamics and Automation Lab (MEDAL) at the University of Calgary",
    ...
    content: [
      "Built an app to convert accelerometer data of an inclinometer into displacement algorithms and display it in a live GUI using SIMULINK, MATLAB and GUIDE",
    ],
  },
  {
    company: "ABB",
    ...
    content: [
      "Created a unit-testing framework for an electro-magnetic solver using Python",
    ],
  },
];
    ...
    return (
      <React.Fragment key={item.company}>
        ...
        <div className={`content ${active}`}>
          <ul style={{ margin: 0, paddingInlineStart: "20px" }}>{content}</ul>
          <br></br>
